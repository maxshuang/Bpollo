...
describe("POST /ingest/webhook — all event types", () => {
  const events = [
    ...
    { event_type: "inspection.issue_flagged", site_id: "s1", issue_id: "i1", issue_type: "elec", severity: "high" },
    ...
    { event_type: "investigation.opened",     investigation_id: "inv1", linked_issue_ids: ["i1"], severity: "low" },
    { event_type: "investigation.closed",     investigation_id: "inv1", outcome: "resolved" },
  ]
